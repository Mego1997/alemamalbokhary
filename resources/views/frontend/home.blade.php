        ...
        <div class="container">
            <div class="row align-items-center flex-column-reverse  flex-md-row">
                ...
                <div class="col-md-6">
                    <div class="banner-item">
                        <div class="banner-inner">
                            <div class="banner-content align-middle" style="text-align: right">
                                <h1>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="lab-item feature-item text-xs-center">
                        <div class="lab-inner">
                            ...
                            <div class="lab-content">
                                <h5>التعليم والتدريب</h5>
                                <p>

                                    تقديم الفرص التعليمية والتدريبية للأفراد لتمكينهم من تحسين قدراتهم وفرص العمل  </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="lab-item feature-item">
                        <div class="lab-inner">
                            ...
                            <div class="lab-content">
                                <h5>التبرعات والمساهمات</h5>
                                <p>
                                    تعتمد الجمعية على التبرعات والمساهمات من الأفراد والمؤسسات لتمكينها من تحقيق أهدافها ومساعدة المحتاجين.  </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="lab-item feature-item">
                        <div class="lab-inner">
                            ...
                            <div class="lab-content">
                                <h5>الرعاية الصحية</h5>
                                <p>
                                    تقديم الخدمات الطبية والرعاية الصحية للفئات المحتاجة والمرضى غير القادرين على تحمل التكاليف الطبية.
                                </p>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="lab-item feature-item">
                        <div class="lab-inner">
                            ...
                            <div class="lab-content">
                                <h5>المساعدة الإجتماعية</h5>
                                <p>
                                    تقديم المساعدة المالية والعينية للأفراد والأسر المحتاجة مثل توفير الغذاء والمأوى والملبس والرعاية الصحية.
                                </p>
