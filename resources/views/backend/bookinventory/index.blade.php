            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/bookinventory/create') }}">
                            إضافة كتاب
                        </a>
                            ...
                            @endif
                                ...
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <button type="button" class="btn btn-danger text-dark font-medium-2">
                                        اجمالي اسعار الكتب : <span class="badge badge-danger text-dark font-medium-2">{{$inventories->sum('total')}} جنية</span>
                                    </button>
                                </div>
                                    ...
                                    @foreach ($inventories as $key => $inventory)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('bookinventory.edit', $inventory->id) }}"
                                                    class="btn btn-sm btn-warning">تعديل</a>
{{--                                                <button class="btn btn-sm btn-danger" data-toggle="modal"--}}
{{--                                                    data-target="#danger{{ $inventory->id }}">حذف</button>--}}
                                            </td>
                                        </tr>
                                        <!-- Modal -->
