            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title"> الاسباب</h4>
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/reasons/create') }}">
                            إضافة سبب
                        </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-float btn-float-md btn-danger" data-toggle="modal"
                                                    data-target="#danger{{ $reason->id }}">حذف</button>
                                            </td>
                                        </tr>
                                        <!-- Modal -->
                                        <div class="modal fade text-left" id="danger{{ $reason->id }}" tabindex="-1" role="dialog"
