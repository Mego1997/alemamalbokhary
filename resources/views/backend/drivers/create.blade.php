    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">اضافه سائق</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">الصفحة الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/driver') }}">سائقين</a>
                            </li>
                            <li class="breadcrumb-item active">اضافه سائق</li>
                        </ol>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1"
                                                            class="form-control border-primary" placeholder="اسم السائق"
                                                            name="name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1"
                                                            class="form-control border-primary" placeholder="رقم البطاقة"
                                                            name="code">
                                                    </div>
                                                </div>
