            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title">فواتير المبيعات</h4>
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/quraninvoicesale/create') }}">
                            إضافة فاتوره
                        </a>
                                ...
                                <tbody>
                                    @foreach ($invoices as $key => $invoice)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td><a
                                                    href="{{ route('quranstudents.show', $invoice->students->id) }}">{{ $invoice->students->name }}</a>
                                            </td>
                                            <td>{{ $invoice->type }}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('quraninvoicesale.show', $invoice->id) }}"
                                                    class="btn btn-float btn-float-md btn-success">طباعة</a>


{{--                                                <a href="{{ route('quraninvoicesale.edit', $invoice->id) }}"--}}
