                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/quraninvoicesale') }}">الفواتير</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('quraninvoicesale.store') }}" method="post"
                                                ...
                                                <div class="col-md-6" >
                                                    ...
                                                    <div class="form-group" data-select2-id="758">
                                                        <select  class="custom-select select2 border-primary "
                                                                 id="classes">
                                                            <option value="0">اختار اسم الكتاب</option>
