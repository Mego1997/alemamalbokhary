...
@section('title', 'فواتير المتبرعين')
@section('body')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title">فواتير المتبرعين</h4>
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/donationinvoicepurchases/create') }}">
                            إضافة فاتوره
                        </a>
                                ...
                                <tbody>
                                    @foreach ($invoices as $key => $invoice)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('donationinvoicepurchases.show', $invoice->id) }}"
