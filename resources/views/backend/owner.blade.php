...
@section('title', 'تقارير رئيس مجلس الادارة')
@section('body')
                            ...
                            <div class="col-xl-9 col-lg-12">
                                <div class="card">
                                    <div class="card-header border-0-bottom">
                                        <h4 class="card-title">اخر التحديثات بتاريخ {{now()->format('Y-m-d')}}</h4>
                                    ...
                                    <div class="card-content">
                                        <div id="daily-activity" class="table-responsive height-350">
                                            <table class="table table-hover mb-0">
                                                ...
                                                @empty
                                                    <td class="text-center" colspan="5">لايوجد بيانات للعرض</td>
                                                @endforelse
                            ...
                            <div class="col-xl-3 col-lg-12 border-right-blue-grey border-right-lighten-5">
                                <div class="my-1 text-center">
                                    ...
                                    <div class="card-content">
                                        <ul class="list-inline clearfix pt-1 mb-0">
                                            <li class="border-right-grey border-right-lighten-2 pr-2">
                                                <h2 class="grey darken-1 text-bold-400">{{$bookss->sum('income')}} جنية</h2>
                                                <span class="primary"><span class="feather icon-arrow-up"></span>
                                                    ايرادات</span>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="card-content">
                                                <ul class="list-inline clearfix pt-1 mb-0">
                                                    <li class="border-right-grey border-right-lighten-2 pr-2">
                                                        <h2 class="grey darken-1 text-bold-400">{{$bookss->sum('outgoings')}} جنية</h2>
                                                <span class="danger"><span class="feather icon-arrow-down"></span>
                                                    مصروفات</span>
                                            </li>
                                                </ul>
                                                    ...
                                                    <div class="card-content">
                                                        <ul class="list-inline clearfix pt-1 mb-0">
                                                            <li class="border-right-grey border-right-lighten-2 pr-2">                                                <h2 class="grey darken-1 text-bold-400">{{$inbook->sum('remaning')}} جنية</h2>
                                                <span class="danger"><span class="feather icon-arrow-down"></span>
                            ...
                            <div class="col-xl-3 col-lg-12 border-right-blue-grey border-right-lighten-5">
                                <div class="my-1 text-center">
                                    ...
                                    <div class="card-content">
                                        <ul class="list-inline clearfix pt-1 mb-0">
                                            <li class="border-right-grey border-right-lighten-2 pr-2">
                                                <h2 class="grey darken-1 text-bold-400">{{$clothess->sum('income')}} جنية</h2>
                                                <span class="primary"><span class="feather icon-arrow-up"></span>
                                                    ايرادات</span>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="card-content">
                                        <ul class="list-inline clearfix pt-1 mb-0">
                                            <li class="border-right-grey border-right-lighten-2 pr-2">
                                                <h2 class="grey darken-1 text-bold-400">{{$clothess->sum('outgoings')}} جنية</h2>
                                                <span class="danger"><span class="feather icon-arrow-down"></span>
                                                    مصروفات</span>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="card-content">
                                        <ul class="list-inline clearfix pt-1 mb-0">
                                            <li class="border-right-grey border-right-lighten-2 pr-2">
                                                ...
                                                <span class="danger">
                                                    <span class="feather icon-arrow-down"></span>ديون
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="card-content">
                                        <div id="daily-activity" class="table-responsive height-350">
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                @forelse($donations as $key => $safee)
                                                    <tr>
                                                        <td>{{ $key + 1 }}</td>
                                                        <td>{{ $safee->income }}</td>
                                                        <td>{{ $safee->outgoings }}</td>
                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col-xl-3 col-lg-12 border-right-blue-grey border-right-lighten-5">
                                <div class="my-1 text-center">
                                    <div class="card-header mb-2 pt-0">
                                        <h2 class="primary font-large-2">خزنة دار التحفيظ</h2>
                                        <h3 class="font-large-1 text-bold-200">{{$quran->balance}} جنية</h3>
                                        <h5 class="primary">الرصيد الحالي</h5>
                                    ...
                                    <div class="card-content">
                                        <ul class="list-inline clearfix pt-1 mb-0">
                                            <li class="border-right-grey border-right-lighten-2 pr-2">
                                                <h2 class="grey darken-1 text-bold-400">{{$qurans->sum('income')}} جنية</h2>
                                                <span class="primary"><span class="feather icon-arrow-up"></span>
                                                    ايرادات</span>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="card-content">
                                        <ul class="list-inline clearfix pt-1 mb-0">
                                            <li class="border-right-grey border-right-lighten-2 pr-2">
                                                <h2 class="grey darken-1 text-bold-400">{{$qurans->sum('outgoings')}} جنية</h2>
                                                <span class="danger"><span class="feather icon-arrow-down"></span>
                                                    مصروفات</span>
                                            </li>
                                        </ul>
