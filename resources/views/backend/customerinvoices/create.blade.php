                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/customerinvoice') }}">الفواتير</a>
                            </li>
...
{{--                                    @endif--}}
                                        ...
                                        @endif
                                    <form class="form" action="{{ route('customerinvoice.store') }}" method="post"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>اسم العميل</h4>
                                            ...
                                            <div class="row" id="mego">
                                                ...
                                                <div class="col-md-4">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>الكمية المتاحة</h4>
                                                    <div class="form-group">
                                                        <input type="text" id="request_quantity"
                                                               class="form-control border-primary"
                                                               value="0" readonly>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="number"  id="quantityy"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                <button class="btn btn-primary w-100" type="button" id="moreee">اضافة</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row" id="add">
                                                <table id="buyy" class="table table-striped table-bordered dom-jQuery-events text-white" style="background-color: grey !important">
                                                    <thead>
                                                        <tr>
                                                        <th>أسم المنتج</th>
                                                        <th>سعر المنتج</th>
