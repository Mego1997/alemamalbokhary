            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/customerinvoice/create') }}">
                            إضافة فاتوره
                        </a>
                                ...
                                <tbody>
                                    @foreach ($invoicess as $key => $invoice)
                                        <tr>
                                            ...
                                            <td>{{ $invoice->phone }}</td>
                                            <td>
                                               <textarea disabled class="border-0">
                                                    @foreach($invoice->customer_detail as $inv)
                                                       {{$inv->class}}
                                                   @endforeach
                                               </textarea>
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ route('customerinvoice.show', $invoice->id) }}"
