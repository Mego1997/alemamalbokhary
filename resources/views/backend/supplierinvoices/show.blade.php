                ...
                <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/dashboard/invoices">الفواتير</a>
                            </li>
                                    ...
                                    <div class="row invoice-adress-info py-2">
                                        <div class="col-6 mt-1 from-info">
                                            ...
                                            <div class="company-name mb-1">
                                                <span class="text-muted">{{ $invoice->suppliers->name }}</span>
                                            </div>
                                            <div class="company-address mb-1">
                                                <span class="text-muted">{{ $invoice->suppliers->phone }}</span>
                                            </div>
                                            <div class="company-email  mb-1 mb-1">
                                                <span class="text-muted">{{ $invoice->suppliers->address }}</span>
                                            </div>
