    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">تعديل موظف</h3>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-colored-form-control">تعديل موظف</h4>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="date" id="userinput1"
                                                               ...
                                                               name="join_date" value="{{$employee->join_date}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1"
                                                               ...
                                                               name="degree" value="{{$employee->degree}}" >
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="specialization_id" class="custom-select border-primary">
                                                            @foreach ($specializations as $specialization)
                                                                <option value="{{ $specialization->id }}"  {{ $specialization->id == $employee->specialization_id ? 'selected' : '' }}>{{ $specialization->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @foreach ($classes as $classe)
                                                            <div class="form-check form-check-inline">
                                                                ...
                                                                <input class="form-check-input " type="checkbox" value="{{ $classe->id }}"  name="class_id[]"  id="defaultCheck1"
                                                                @foreach($class as $clas)
                                                                    {{ ( $clas->class_id == $classe->id)? "checked" : "" }}
                                                                    @endforeach
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <h4 class="form-section text-dark"><i class="fa fa-photo"></i>
                                                        صورة شخصية  </h4>
                                                    <img src="{{ url('public/employees/' .$employee->image) }}" width="50" height="50" alt="">
                                                    <label id="projectinput7" class="file center-block">
                                                        <input type="file" id="file" name="image" value="{{$employee->image}}">
