                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('quranstudents.update', $student->id) }}" method="post"
                                        ...
                                        <div class="form-body">
                                                        ...
                                                        @foreach ($classes as $classe)
                                                            <div class="form-check form-check-inline">
                                                                ...
                                                                @foreach($class as $clas)
                                                                    {{ ( $clas->quran_id == $classe->id)? "checked" : "" }}
                                                                    @endforeach
                                                                >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <img src="{{ url('public/quranstudents/' .$student->image) }}" width="50" height="50" alt="">
