    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">اضافة طالب</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">الصفحة الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/quranstudent') }}">جميع الطلاب</a>
                            </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-colored-form-control">اضافة طالب</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('quranstudents.store') }}" method="post"
                                        ...
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1"
                                                            class="form-control border-primary" placeholder="اسم الطالب"
                                                            name="name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <h4 class="form-section text-dark"><i class="feather icon-edit-1"></i> الأجزاء</h4>
