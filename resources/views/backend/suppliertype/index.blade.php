            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title">انواع المواردين</h4>
{{--                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/suppliertype/create') }}">--}}
{{--                            إضافة نوع مورد--}}
{{--                        </a>--}}
...
{{--                                                <a href="{{ route('suppliertype.edit', $type->id) }}"--}}
