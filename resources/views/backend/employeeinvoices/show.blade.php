                ...
                <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/dashboard/employeeinvoices">الفواتير</a>
                            </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div class="row invoice-adress-info py-2">
                                        <div class="col-6 mt-1 from-info">
                                            ...
                                            <div class="company-name mb-1">
                                                <span class="text-muted">{{ $invoice->employees->name }}</span>
                                            </div>
                                            <div class="company-address mb-1">
                                                <span class="text-muted">{{ $invoice->employees->phone }}</span>
                                            </div>
                                            <div class="company-email  mb-1 mb-1">
                                                <span class="text-muted">{{ $invoice->employees->address }}</span>
                                            </div>
                                    ...
                                    <div class="product-details-table py-2 table-responsive">
                                        <table class="table table-borderless text-bold-700">
