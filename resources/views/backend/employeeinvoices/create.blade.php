...
{{--                                    @endif--}}
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('employeeinvoices.store') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>اسم الموظف</h4>
                                                ...
                                                <div id="donee" class="col-md-2">
                                                    ...
                                                    <div class="form-group">
                                                <button class="btn btn-primary" type="button" id="doit">اضافة</button>
                                                    </div>
                                                </div>
