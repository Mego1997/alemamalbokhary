            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title"> المصروفات الدراسية</h4>
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/requested_prices/create') }}">
                            إضافة  مصروفات
                        </a>
                                    ...
                                    @foreach ($types as $key => $type)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('requested_prices.edit', $type->id) }}"
                                        ...
                                        <div class="modal fade text-left" id="danger{{ $type->id }}" tabindex="-1" role="dialog"
                                            ...
                                            <form action="{{ route('requested_prices.destroy', $type->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
