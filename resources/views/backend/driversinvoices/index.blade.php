            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/driverinvoices/create') }}">
                            إضافة فاتوره
                        </a>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                <tbody>
                                    @foreach ($invoices as $key => $invoice)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td><a href="{{ route('drivers.show', $invoice->driver_id  ) }}">{{$invoice->drivers->name }}</a></td>
                                            <td>{{ $invoice->paid }}</td>
