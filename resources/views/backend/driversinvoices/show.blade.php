            ...
            <div class="content-header row">
                ...
                <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/dashboard/students">الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item"><a href="/dashboard/driverinvoices">الفواتير</a>
                            </li>
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div class="row invoice-adress-info py-2">
                                        <div class="col-6 mt-1 from-info">
                                            ...
                                            <div class="company-name mb-1">
                                                <span class="text-muted">{{ $invoice->drivers->name }}</span>
                                            </div>
                                            <div class="company-name mb-1">
                                                <span class="text-muted">{{ $invoice->drivers->birthday }}</span>
                                            </div>
                                            <div class="company-name mb-1">
                                                <span class="text-muted">{{ $invoice->drivers->code }}</span>
                                            </div>
                                            <div class="company-address mb-1">
                                                <span class="text-muted">{{ $invoice->drivers->phone }}</span>
                                            </div>
                                            <div class="company-email  mb-1 mb-1">
                                                <span class="text-muted">{{ $invoice->drivers->address }}</span>
                                            </div>
                                    ...
                                    <div class="product-details-table py-2 table-responsive">
                                        <table class="table table-borderless">
                                            ...
                                            <tbody>
                                                @foreach ($invoices as $invoicee )


                                                <tr>
                                                    <td>{{ $invoicee->name }}</td>
                                                    <td>{{ $invoicee->location }}</td>
                                                    <td>{{ $invoicee->price }}</td>
                                                    <td>{{ $invoicee->quantity }}</td>
                                                    <td>{{ $invoicee->single_total }}</td>
                                                    <td>{{ $invoicee->created_at}}</td>
                                                </tr>
                                                @endforeach
                                            ...
                                            <div class="col-8 col-sm-6 d-flex justify-content-end mt-75">
                                                <ul class="list-group cost-list">
                                                    <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                                        <span class="cost-title mr-2">اجمالي الفاتورة </span>
                                                        <span class="cost-value">{{$invoice->total}} جنية</span>
                                                    </li>
                                                    <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                                        <span class="cost-title mr-2">اجمالي المدفوع</span>
                                                        <span class="cost-value">{{$invoice->paid}} جنية</span>
                                                    </li>

                                                    <li class="dropdown-divider"></li>
                                                    <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                                        <span class="cost-title mr-2">اجمالي المتبقي</span>
                                                        <span class="cost-value">{{$invoice->remaning}} جنية</span>
                                                    </li>
