                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/driverinvoices') }}">الفواتير</a>
                            </li>
...
{{--                                    @endif--}}
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('driverinvoices.store') }}" method="post"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>اسم السائق</h4>
                                                ...
                                                <div class="col-md-3">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>الخط</h4>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>سعر الخط</h4>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>عدد الطلاب</h4>
                                                    <div class="form-group">
                                                        <input type="text" id="quan"
                                                            class="form-control border-primary" placeholder="عدد الطلاب"
                                                            >
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="form-group">
                                                <button class="btn btn-primary" type="button" id="edafa">اضافة</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row" >
                                                <table id="edafaa" class="table table-striped table-bordered dom-jQuery-events text-white" style="background-color: grey !important">
                                                    <thead>
                                                        <tr>
                                                        <th>أسم السائق</th>
                                                        <th> الخط</th>
