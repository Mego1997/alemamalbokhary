...
@section('title', 'فواتير تحفيظ القران')
@section('body')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title text-bold-800">فواتير تحفيظ القران</h4>
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/quraninvoices/create') }}">
                            إضافة فاتوره
                        </a>
                            ...
                            <table class="table table-striped table-bordered zero-configuration  text-bold-700">
                                ...
                                <tbody>
                                    @foreach ($invoices as $key => $invoice)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                           <td ><a  href="{{ route('quranstudents.show', $invoice->quranstudent->id ) }}">{{$invoice->quranstudent->name }}</a></td>
                                            <td>{{ $invoice->price }}</td>
