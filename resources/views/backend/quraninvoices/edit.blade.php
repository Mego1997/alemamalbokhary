                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/invoices') }}">Invoices</a>
                            </li>
                                    ...
                                    <form class="form" action="{{ route('supplierinvoices.update', $invoice->id ) }}" method="post"
                                        ...
                                        <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <input type="hidden" id="userinput1"
                                                                ...
                                                                name="supplier_id"  value="{{ $invoice->suppliers->id }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                                ...
                                                                name="payment_method"  value="{{ $invoice->name }}" disabled >
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>له</h4>
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1"
