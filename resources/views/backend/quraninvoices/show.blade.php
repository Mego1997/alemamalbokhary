                ...
                <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/dashboard/quraninvoices">الفواتير</a>
                            </li>
                                    ...
                                    <div class="row invoice-adress-info py-2">
                                        <div class="col-6 mt-1 from-info">
                                            ...
                                            <div class="company-name mb-1">
                                                <span class="text-muted">{{ $invoice->quranstudent->name }}</span>
                                            </div>
                                            <div class="company-address mb-1">
                                                <span class="text-muted">{{ $invoice->quranstudent->parent_phone }}</span>
                                            </div>
                                            <div class="company-email  mb-1 mb-1">
                                                <span class="text-muted">{{ $invoice->quranstudent->address }}</span>
                                            </div>
                                    ...
                                    <div class="product-details-table py-2 table-responsive">
                                        <table class="table table-borderless">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $invoice->quranstudent->name }}</td>
                                                    <td>{{ $invoice->price }}</td>
