            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <a class="btn btn-outline-primary btn-md mt-1 " href="{{ asset('/dashboard/clothesinvoices/create') }}">
                            إضافة فاتوره
                        </a>
                                ...
                                <tbody>
                                    @foreach ($invoices as $key => $invoice)
                                        <tr>
                                            ...
                                            <td>{{ $invoice->clothesinventory->name }}</td>
...
{{--                                                    data-target="#danger{{ $invoice->id }}"> <i class="fa fa-trash"></i> </button>--}}
                                            </td>
                                        </tr>
                                        <!-- Modal -->
