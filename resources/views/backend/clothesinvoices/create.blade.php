                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/clothesinvoices') }}">الفواتير</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('clothesinvoices.store') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="student_id" class="custom-select border-primary"
                                                            id="">
                                                ...
                                                <div class="col-md-6">
                                                    <h4 class="form-section text-dark"><i
                                                        ...
                                                        <select name="book" class="custom-select border-primary"
                                                            id="">
                                                            @foreach ($requested_prices as $requested_price)
                                                                <option value="{{ $requested_price->id }}">
                                                                    {{ $requested_price->name}}
                                                                </option>
