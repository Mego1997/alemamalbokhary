    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">اشتراك باص</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/homepage') }}">الصفحة الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/bussubscription') }}">الفواتير</a>
                            </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-colored-form-control">اشتراك باص</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('bussubscription.store') }}" method="post"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="remining"
                                                               class="form-control border-primary" value="0" readonly
                                                        >
                                                    </div>

                                                </div>
                                                <div id="done" class="col-md-3">
                                                    <h4 class="form-section text-dark"><i
                                                            class="feather icon-edit-2"></i>تأكيد</h4>
                                                    <div class="form-group">
                                                        <button class="btn btn-primary" type="button" id="sub">اضافة</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row" id="add">
                                                <table id="subscrip" class="table table-striped table-bordered dom-jQuery-events text-white" style="background-color: grey !important">
                                                    <thead>
                                                        <tr>
                                                            <th>أسم الخط</th>
                                                            <th>سعر الخط</th>
