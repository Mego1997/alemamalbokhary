                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div class="product-details-table py-2 table-responsive">
                                        <table class="table table-borderless">
                                            ...
                                            @foreach($invoice->bussubscriptionhistory as $history)


                                                <tr>
                                                    <td>{{ $history->locations->name }}</td>
                                                    <td>{{ $history->price }}</td>
                                                    <td>{{ $history->total }}</td>
                                                    <td>{{ $history->paid }}</td>
                                                    <td>{{ $history->remaning }}</td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8 col-sm-6 d-flex justify-content-end mt-75">
                                                <ul class="list-group cost-list">
                                                    ...
                                                    <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                                        <span class="cost-title mr-2">اجمالي الخصم</span>
                                                        <span class="cost-value">{{$invoice->discount}} جنية</span>
                                                    </li>

                                                    <li class="dropdown-divider"></li>
                                                    <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                                        <span class="cost-title mr-2">المتبقي</span>
