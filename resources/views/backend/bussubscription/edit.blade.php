    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">دفع قسط الباص</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">الصفحة الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/invoices') }}">اشتراكات الباص</a>
                            </li>
                            <li class="breadcrumb-item active">دفع قسط الباص</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-colored-form-control">دفع قسط الباص</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('bussubscription.update', $invoice->id ) }}" method="post"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1"
                                                               ...
                                                               name="remaning"  value="{{ $invoice->locations->name }}" readonly>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" placeholder="remaning"
                                                               name="remaning"  value="{{ $invoice->total }}" readonly>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1"
                                                            class="form-control border-primary" placeholder="دفع"
                                                            name="paid">
                                                    </div>
