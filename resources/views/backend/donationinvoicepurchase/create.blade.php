                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/donationsinvoices') }}">الفواتير</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('donationsinvoices.store') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="donat_id"  class="custom-select border-primary"
                                                            >
                                                            <option value="0"> اختار الاسم</option>
                                                            @foreach ($donations as $donation)
                                                                <option value="{{ $donation->id }}">{{ $donation->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="safe"  class="custom-select border-primary"
                                                        >
                                                            <option value="1">خزنة التبرعات</option>
                                                            <option value="2">خزنة الكتب</option>
                                                            <option value="3">خزنة الملابس</option>
                                                            <option value="4">خزنة الحضانة</option>
