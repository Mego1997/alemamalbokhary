    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" @if(auth()->user()->type == 'admin') href='/admin/home' @elseif(auth()->user()->type == 'user') href='/user/home' @elseif(auth()->user()->type == 'owner')  href='/owner/home' @elseif(auth()->user()->type == 'manager')  href='/manager/home'@endif><img class="brand-logo" alt="stack admin logo" src="{{ url('public/backend/app-assets/images/logo/logo2.png') }}">
                        <h3 class="brand-text">جمعية الامام البخاري</h3>
                    </a>
                </li>
...
{{--                                <ul class="row mt-2">--}}
{{--                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="#" target="_blank"><i class="feather icon-mail font-large-1 mr-0"></i>--}}
{{--                                            <p class="font-medium-2 mt-25 mb-0">Email</p>--}}
{{--                                        </a></li>--}}
{{--                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="#" target="_blank"><i class="feather icon-message-square font-large-1 mr-0"></i>--}}
{{--                                            <p class="font-medium-2 mt-25 mb-0">Chat</p>--}}
{{--                                        </a></li>--}}
{{--                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3 mt-75 mt-xl-0" href="#" target="_blank"><i class="feather icon-check-square font-large-1 mr-0"></i>--}}
{{--                                            <p class="font-medium-2 mt-25 mb-0">Todo</p>--}}
{{--                                        </a></li>--}}
{{--                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="#" target="_blank"><i class="feather icon-file-plus font-large-1 mr-0"></i>--}}
{{--                                            <p class="font-medium-2 mt-25 mb-50">Kanban</p>--}}
{{--                                        </a></li>--}}
{{--                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="#" target="_blank"><i class="feather icon-users font-large-1 mr-0"></i>--}}
{{--                                            <p class="font-medium-2 mt-25 mb-50">Contacts</p>--}}
{{--                                        </a></li>--}}
{{--                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="#" target="_blank"><i class="feather icon-printer font-large-1 mr-0"></i>--}}
...
{{--                                            <div class="avatar avatar-online avatar-sm rounded-circle"><img src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></div>--}}
{{--                                        </div>--}}
{{--                                        <div class="media-body">--}}
...
{{--                                </a><a href="javascript:void(0)">--}}
{{--                                    <div class="media">--}}
{{--                                        <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="{{ url('public/backend/app-assets/images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span></div>--}}
{{--                                        <div class="media-body">--}}
...
{{--                                    <div class="media">--}}
{{--                                        <div class="media-left">--}}
{{--                                            <div class="avatar avatar-online avatar-sm rounded-circle"><img src="{{ url('public/backend/app-assets/images/portrait/small/avatar-s-3.png')}}" alt="avatar"><i></i></div>--}}
{{--                                        </div>--}}
{{--                                        <div class="media-body">--}}
...
{{--                                </a><a href="javascript:void(0)">--}}
{{--                                    <div class="media">--}}
{{--                                        <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="{{ url('public/backend/app-assets/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span></div>--}}
{{--                                        <div class="media-body">--}}
